...
const ToxicButton: React.FC<ToxicButtonProps> = ({ onClick, isLoading, activeColor }) => {
  return (
    <HoverBorderGradient
      ...
      className={`
        relative px-8 py-4 font-black text-lg md:text-xl uppercase tracking-tighter italic overflow-hidden border-none
    ...
    >
      ...
      {/* Световой блик */}
      <div className="absolute inset-0 z-10 opacity-0 hover:opacity-100 transition-opacity duration-1000 bg-gradient-to-r from-transparent via-white/10 to-transparent -translate-x-full hover:translate-x-full" />
    </HoverBorderGradient>
  );
};
